...
function(fetch_stb)
    ...
    foreach(_header IN LISTS args_HEADERS)
        ...
        if(EXISTS ${_stb_dir}/${_header} AND EXISTS ${_STB_IMPL_PATH_INTERNAL})
    ...
    if(_update_cpp)
        ...
        file(WRITE ${_STB_IMPL_PATH_INTERNAL} ${_stb_impl_content})
    endif()
    if(_headers)
        add_library(stb STATIC ${_STB_IMPL_PATH_INTERNAL} ${_headers})
